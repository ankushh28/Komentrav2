...
import {
  ...
  RefreshCw, ImageOff, Copy, AlertTriangle, Youtube,
} from 'lucide-react';
      ...
      <header className="border-b border-slate-200 bg-white/90 backdrop-blur sticky top-0 z-20">
        <div className="container mx-auto px-4 py-3 flex min-w-0 items-center justify-between gap-3">
          ...
          <div className="flex shrink-0 items-center gap-2 md:gap-3">
            ...
            <Button variant="ghost" size="sm" className="hidden md:inline-flex" onClick={() => router.push(`/shorts-sync?workspaceId=${selectedWorkspaceId || ''}`)}>
              <Youtube className="w-4 h-4 mr-1" /> Shorts Sync
            </Button>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem onClick={() => router.push(`/shorts-sync?workspaceId=${selectedWorkspaceId || ''}`)}>
                  <Youtube className="w-4 h-4 mr-2" /> Shorts Sync
                </DropdownMenuItem>
