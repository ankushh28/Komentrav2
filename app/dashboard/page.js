...
import {
  ...
  X, Hash, Shuffle, Wand2, Bot, ChevronRight, BarChart3,
} from 'lucide-react';
    ...
    <Card className="hover:shadow-lg transition-shadow border-l-4 border-l-violet-500">
      <CardContent className="p-5">
        <div className="flex items-start gap-4">
          {a.postThumbnail && <img src={a.postThumbnail} alt="" className="w-24 h-24 rounded-xl object-cover flex-shrink-0 ring-2 ring-violet-100" />}
